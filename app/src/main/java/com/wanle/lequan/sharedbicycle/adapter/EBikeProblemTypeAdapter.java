...
public class EBikeProblemTypeAdapter extends RecyclerView.Adapter<EBikeProblemTypeAdapter.MyViewHolder> {
    private Context mContext;
    private List<String> mData;
    private int lastPressIndex = -1;
    private MyViewHolder mHolder;
    private int mPosition;
    public EBikeProblemTypeAdapter(Context context) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(mContext).inflate(R.layout.item_layout_problem_type, parent, false);
